...
export const JeelizThreeHelper = (function () {
    ...
    function create_videoScreen() {
        ...
        _threeVideoTexture = new THREE.DataTexture(new Uint8Array([255, 0, 0, 1]), 1, 1, THREE.RGBAFormat);
        ...
        const setVideoGeomAttribute = (videoGeometry.setAttribute ||
            videoGeometry.addAttribute).bind(videoGeometry);
